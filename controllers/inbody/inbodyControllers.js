 ...
 *           type: number
 *           format: float
 *           description: 체간근육량 (kg)
 *         left_arm_muscle:
 *           type: number
 *           format: float
 *           description: 좌팔근육량 (kg)
 *         right_arm_muscle:
 *           type: number
 *           format: float
 *           description: 우팔근육량 (kg)
 *         left_leg_muscle:
 *           type: number
 *           format: float
 *           description: 좌다리근육량 (kg)
 *         right_leg_muscle:
 *           type: number
 *           format: float
 *           description: 우다리근육량 (kg)
 *         trunk_fat:
 *           type: number
 *           format: float
 *           description: 체간지방량 (kg)
 *         left_arm_fat:
 *           type: number
 *           format: float
 *           description: 좌팔지방량 (kg)
 *         right_arm_fat:
 *           type: number
 *           format: float
 *           description: 우팔지방량 (kg)
 *         left_leg_fat:
 *           type: number
 *           format: float
 *           description: 좌다리지방량 (kg)
 *         right_leg_fat:
 *           type: number
 *           format: float
 *           description: 우다리지방량 (kg)
 *         inbody_time:
 *           type: string
 *           format: date
 *           description: 측정 날짜
 ...
 * /inbody/{userId}:
 *   get:
 *     summary: 사용자 인바디 데이터 조회
 *     description: 특정 사용자의 인바디 데이터를 조회합니다.
 *     tags: [인바디]
 *     security:
 *       - sessionAuth: []
 *     parameters:
 ...
 *           type: string
 *           format: date
 *         description: 측정 날짜 (YYYY-MM-DD), 기본값은 최근 데이터
 *     responses:
 *       200:
 *         description: 인바디 데이터 조회 성공
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   type: array
 *                   items:
 *                     $ref: '#/components/schemas/InbodyData'
 *                 standardData:
 *                   type: array
 *                   items:
 *                     $ref: '#/components/schemas/InbodyStandard'
 *                 inbodyTimeResult:
 *                   type: array
 *                   items:
 *                     type: object
 ...
 * /inbody/{userId}/month:
 *   get:
 *     summary: 사용자 인바디 월별 데이터 조회
 *     description: 특정 기간의 인바디 측정 날짜 목록을 조회합니다.
 *     tags: [인바디]
 *     security:
 *       - sessionAuth: []
 *     parameters:
...
/**
 * @swagger
 * /inbody/{userId}/register:
 *   post:
 *     summary: 인바디 데이터 등록
 *     description: 새로운 인바디 측정 데이터를 등록합니다.
 *     tags: [인바디]
 *     security:
 *       - sessionAuth: []
 *     parameters:
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/InbodyRegisterRequest'
 *     responses:
 *       201:
 *         description: 인바디 데이터 등록 성공
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: "인바디 데이터가 성공적으로 등록되었습니다"
 *                 inbodyId:
 *                   type: integer
 *                   description: 등록된 인바디 ID
 *       400:
 *         description: 잘못된 요청
 *         $ref: '#/components/responses/ValidationError'
 *       500:
